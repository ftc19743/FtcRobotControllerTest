...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.45928;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "flmAndRightForwardEncoder");
        rightFront = hardwareMap.get(DcMotorEx.class, "frmAndStrafeEncoder");
        rightRear = hardwareMap.get(DcMotorEx.class, "brm");
        leftRear = hardwareMap.get(DcMotorEx.class, "blmAndLeftForwardEncoder");
